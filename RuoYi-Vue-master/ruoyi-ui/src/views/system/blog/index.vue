<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="${comment}" prop="postTitle">
        <el-input
      ...
      <el-form-item label="${comment}" prop="postAuthor">
        <el-input
      ...
      <el-form-item label="${comment}" prop="postDate">
    ...
    <el-table v-loading="loading" :data="blogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="postID" />
      <el-table-column label="${comment}" align="center" prop="postTitle" />
      <el-table-column label="${comment}" align="center" prop="postAuthor" />
      <el-table-column label="${comment}" align="center" prop="postDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.postDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="${comment}" align="center" prop="postStatus" />
      <el-table-column label="${comment}" align="center" prop="userID" />
      <el-table-column label="${comment}" align="center" prop="postContent" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="postTitle">
          <el-input v-model="form.postTitle" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="postAuthor">
